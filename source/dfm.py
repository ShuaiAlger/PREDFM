...
from PREDFMatcher import PREDFMatcher

from REDFM import REDFM
...
def demo_hpatches(function_match):
    ...
    dataset_path='/media/shuai/Correspondence/DATASETS/rotated-HPatches'
    img_format = ".png"
...
if __name__ == '__main__':
    ...
    if USE_DFM:
        manym = DeepFeatureMatcher("VGG19_BN", "cuda", True, False, [0.95, 0.95, 0.95, 0.99, 1.0])
        demo_camera_pose(manym.match,
                        USE_ROT90_DATASET=0,
    ...
    if USE_PRESDKDFM:
        manym = PREDFMatcher(model = config['model'],
                            DETECTOR = 1, # # 0 is FAST, 1 is Shi-Tomasi, 2 is SuperPoint
                            USE_FEATURE_SCALE = 3,
                            USE_IMAGE_SCALE = 8,
                            USE_SHIFT = 1
                            )
        ...
        # MegaDepth-Rot-90   # PRESDKDFM # c8-resnet18, shitomasi, feature-4, scale-8, shift # 15.69 27.66 42.20 52.17
        # MegaDepth-Rot-Rand # PRESDKDFM # c8-resnet18, shitomasi, feature-4, scale-8, shift # 12.05 21.77 34.18 55.69

        # rotated-hpatches # PRESDKDFM # c4-resnet18, shitomasi, feature-4, scale-8, shift # 1 : 0.108342595,2 : 0.19431853,3 : 0.23772775,4 : 0.2645111,5 : 0.28348333,6 : 0.29789075,7 : 0.30980185,8 : 0.31974998,9 : 0.32852963,10 : 0.33560926
        # rotated-hpatches # PRESDKDFM # c8-resnet18, shitomasi, feature-4, scale-8, shift # 1 : 0.16626112,2 : 0.30694997,3 : 0.38039446,4 : 0.42479444,5 : 0.45555928,6 : 0.4785167,7 : 0.4968241,8 : 0.5117037,9 : 0.52387965,10 : 0.5342944
        # 3, 5, 10 # 0.23772775   0.28348333   0.33560926
        # 3, 5, 10 # 0.38039446   0.45555928   0.5342944


    # if USE_REDFM:
    #     manym = REDFM(model = config['model'],
    #                         DETECTOR = 1, # # 0 is FAST, 1 is Shi-Tomasi, 2 is SuperPoint
    #                         USE_FEATURE_SCALE = 4,
    #                         USE_IMAGE_SCALE = 4,
    #                         USE_SHIFT = 1
    ...
    #                     )
        ...
        # demo_hpatches(manym.match)




# MegaDepth # USE_PRESDKDFM # c8resnet18 # multi-scale-4 # image-scale-8 # with shift
# 26.38 42.23 58.13 60.24

# MegaDepth-rot90 # USE_PRESDKDFM # c8resnet18 # multi-scale-4 # image-scale-8 # with shift
# 15.69 27.66 42.20 52.17

# MegaDepth-rot-rand # USE_PRESDKDFM # c8resnet18 # multi-scale-4 # image-scale-8 # with shift
# 9.85 19.20 32.21 45.47
...
# MegaDepth # USE_PRESDKDFM # c8resnet18 # multi-scale-3 # image-scale-8 # with shift
# 22.15 37.21 53.69 51.99

# MegaDepth-rot90 # USE_PRESDKDFM # c8resnet18 # multi-scale-3 # image-scale-8 # with shift
# 12.11 22.81 37.09 42.88

# MegaDepth-rot-rand # USE_PRESDKDFM # c8resnet18 # multi-scale-3 # image-scale-8 # with shift
# 8.26 16.14 27.62 36.60
